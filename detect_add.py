...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./runs/fusion_add/exp3/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--project', default='runs/add_detect', help='save results to project/name')
