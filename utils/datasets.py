...
# FQY: Construct a random sampling sampler for subsequent dual-modal input
...
class LoadMultiModalImagesAndLabels(Dataset):  # for training/testing
    """
    FQY: Load multi-modal data (RGB and IR)
    """
...
def load_mosaic_RGB_IR(self, index1, index2):
    ...
    assert index_rgb == index_ir, 'INDEX_RGB must equal INDEX_IR'
