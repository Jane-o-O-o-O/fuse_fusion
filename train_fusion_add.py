'''
As a contrast, only addition is provided
'''
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='./models/yolov5l_fusion_add.yaml', help='model.yaml path')
    ...
    parser.add_argument('--project', default='runs/fusion_add', help='save to project/name')
