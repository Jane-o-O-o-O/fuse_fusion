...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='./runs/train/fuse_align/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source1', type=str, default='./fuse_dataset/images/rgb/test/', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--source2', type=str, default='./fuse_dataset/images/ir/test/', help='source')  # file/folder, 0 for webcam
    ...
    parser.add_argument('--project', default='runs/two_detect', help='save results to project/name')
