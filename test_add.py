...
def test(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        with torch.no_grad():
            ...
            out, train_out = model(img_rgb, img_ir, augment=augment)  # 更改
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='./runs/fusion_add/exp4/weights/best.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--project', default='runs/two_test', help='save to project/name')
